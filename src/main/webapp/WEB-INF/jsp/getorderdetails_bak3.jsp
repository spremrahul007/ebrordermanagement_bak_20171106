...
<div class="w3l_agileits_breadcrumbs">
	<div class="w3l_agileits_breadcrumbs_inner">
		<ul>
			...
			<li>Order Management <span>«</span></li>
        	...
        	<c:forEach var="contact" items="${listContact}" varStatus="status">
	        	<tr>
		        	<!--  	<td>${status.index + 1}</td>-->
						...
						<td><p id="showTable" data-id="1" data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit"  data-target-id="${contact.shipname}" data-target-orderno="${contact.orderno}"><span class="glyphicon glyphicon-pencil"></span></button></p></td>
         ...
         $('#submit').click(function(){  
          ...
          //  alert(id1);
            ...
            // alert("DENIED: " +  Denied);
             ...
             var id2= "<%= request.getParameter("fromdate") %>";
             var id3= "<%= request.getParameter("todate") %>";
             var id4= "<%= request.getParameter("k") %>";
            //alert(id);
            //alert(id1);
             alert(id2  + "," + id3 + ","  + id4);
