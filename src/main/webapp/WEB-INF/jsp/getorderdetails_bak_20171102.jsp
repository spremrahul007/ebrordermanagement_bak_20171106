...
<div class="card text-white bg-secondary my-4 text-center">
  ...
  <ul class="nav nav-tabs" id="myTab">
			...
			<div class="tab-content">			
			  ...
			  <td>
			    <input type="checkbox" class="chkNumber" name="type" value="1" />OverView<br/>
				<input type="checkbox" class="chkNumber" name="type" value="2" />General<br/>
				<input type="checkbox" class="chkNumber" name="type" value="3" />Coastal<br/>
				<input type="checkbox" class="chkNumber" name="type" value="4" />Approach<br/>
				<input type="checkbox" class="chkNumber" name="type" value="5" />Harbour<br/>
				<input type="checkbox" class="chkNumber" name="type" value="6" />Berthing<br/>			  
			  </td>
			  </tr>
			  </table>
