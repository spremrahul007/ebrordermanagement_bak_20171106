...
<div class="card text-white bg-secondary my-4 text-center">
        <div class="card-body">
			  ...
			  <form action="getencorderdetails" method ="POST"  >
   ...
   <ul class="nav nav-tabs" id="myTab">
			  <li class="active"><a data-target="#home" data-toggle="tab">MapView</a></li>
			  <li><a data-target="#profile" data-toggle="tab">GridView</a></li>			  
			</ul>

			<div class="tab-content">
			  <div class="tab-pane active" id="home"><div id="map"></div></div>
			  ...
			  <table id="example" class="display">
                ...
                <th>Price</th>
                <th>OrderStatus</th>
                <th>ApprovalDateTime</th>
                <th>RecvOnBoardDateTime</th>                
                <th>Action</th>                          
            </tr>
                   </thead>
   <tbody>
        	<c:forEach var="contact" items="${listContact}" varStatus="status">
	        	<tr>
		        	<!--  	<td>${status.index + 1}</td>-->
					    ...
					    <td>${contact.approvalDateTime}</td>
					    <td>${contact.recvOnBoardDateTime}</td>
	    ...
	    //var locations1	 = "${contacts}";
	      ...
	      function initMap() {
	    	   ...
	    	   $.ajax({
	   	    	type:"GET",
	    	       url : 'ajax.html',
	    	       data : {id : "${k}" ,fromdate: null, todate:null},
